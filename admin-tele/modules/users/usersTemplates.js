...
export const UsersTemplates = {
    ...
    userCard: (u, sortType = 'newest', thisMonthKey = '', lastMonthKey = '', index = 0) => {
        ...
        return `<div id="user-card-${_esc(u.id)}" class="usr-card ${statusClass}" data-id="${_esc(u.id)}" data-status="${exactStatus}" data-action="view-user">
                    ...
                    <div class="usr-bottom">
                        <div class="usr-meta"><span class="usr-username" dir="ltr">${u.username ? '@' + _esc(u.username) : '---'}</span><span class="uid-capsule" title="رقم العميل"><i class="fa-solid fa-hashtag"></i>${_esc(u.id)}</span></div>
        ...
        return `
            <div id="tab-overview" class="ud-tab-content active">
                ...
                <div class="ud-info-list">
                    ...
                    <div class="ud-info-row"><span class="ud-info-lbl"><i class="fa-solid fa-fingerprint"></i> معرف العميل (ID)</span><span class="ud-info-val" title="رقم العميل"><span class="uid-capsule font-lg"><i class="fa-solid fa-hashtag"></i>${_esc(u.id)}</span></span></div>
            ...
            <div id="tab-security" class="ud-tab-content">
                <div class="ud-section">
                    ...
                    <div class="ud-status-wrapper mt-10"><span class="ud-info-lbl ud-status-lbl">عنوان IP الأخير:</span><span class="num-en ud-copyable font-lg" dir="ltr" title="انقر للنسخ" data-action="copy-to-clipboard">${u.lastIp ? _esc(u.lastIp) : 'غير متوفر'}</span></div>
                    <div class="ud-actions-col">
        ...
        <div id="tier-user-${_esc(u.id)}" class="tier-user-card pro-interactive-card" data-id="${_esc(u.id)}" data-action="view-user">
            <div class="tuc-main-header">
                <div class="tuc-head">
                    ...
                    <div class="tuc-info">
                        <h4>${safeName}</h4>
                        <span class="uid-capsule"><i class="fa-solid fa-hashtag"></i>${_esc(u.id)}</span>
                    </div>
                </div>
            ...
            <div class="kyc-req-header clickable-header" data-action="view-user" data-id="${_esc(user.id)}" title="فتح ملف العميل الشامل">
                ...
                <div class="kyc-req-user-info">
                    ...
                    <div class="d-flex align-items-center gap-2 mt-1">
                        <span class="uid-capsule m-0"><i class="fa-solid fa-hashtag"></i>${_esc(user.id)}</span>
    ...
    userEditForm: (u) => `
        ...
        <div class="form-row-2 flex-gap-10 mt-10">
            <div class="form-group flex-1">
                <label class="form-label">كلمة مرور جديدة (اختياري)</label>
                <input type="text" id="user-pwd-new" class="form-input num-en" dir="ltr" lang="en" placeholder="اتركه فارغاً...">
            </div>
            <div class="form-group flex-1">
                <label class="form-label">تأكيد المرور</label>
                <input type="text" id="user-pwd-confirm" class="form-input num-en" dir="ltr" lang="en">
            </div>
        </div>
