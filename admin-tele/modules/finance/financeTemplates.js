                    ...
                    <div class="o-card-header-row">
                        ...
                        <div class="o-card-content">
                            ...
                            <div class="o-card-meta">
                                <div class="o-card-user"><i class="fa-solid fa-user o-card-user-icon"></i> <span class="user-name-text">${_esc(userName)}</span> <span class="uid-capsule" title="انقر لنسخ رقم العميل" data-action="copy-text" data-copy-text="${_esc(d.userId)}"><i class="fa-solid fa-hashtag"></i>${_esc(d.userId)}</span></div>
