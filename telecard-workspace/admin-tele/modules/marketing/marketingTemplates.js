...
export const MarketingTemplates = {
    ...
    unifiedAlertCard: (alert) => {
        ...
        if (alert.targetType === 'tier') { 
            targetText = `مستوى مخصص`; targetIcon = 'fa-crown text-gold'; 
            targetIdHtml = alert.targetId ? `<span class="num-en text-warning" dir="ltr">#${_esc(alert.targetId)}</span>` : '';
        } 
